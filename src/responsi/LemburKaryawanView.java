 ...
 */
public class LemburKaryawanView extends JFrame{
    ...
    JLabel lTotalGajiValue = new JLabel("");
    
    JButton btnKembali = new JButton("Kembali");
    
    public LemburKaryawanView(String titleNama) {
        ...
        add(lTotalGaji);
        lTotalGaji.setBounds(20, 180, 80, 20);
        ...
        add(lTotalGajiValue);
        lTotalGajiValue.setBounds(140, 180, 200, 20);
